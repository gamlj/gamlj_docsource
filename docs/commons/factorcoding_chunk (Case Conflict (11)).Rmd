...
It allows to code the categorical variables accoring to different coding schemas. The coding schema applies to the parameter estimates, simple effects and plots. The Omnibus Tests (ANOVA) table uses always the "deviation" scheme, that is "-1 0 1" coding. _default_ uses the factor coding "contr.sum", that is the -1 0 1 coding which results in appropriated Type III Type of analysis.
