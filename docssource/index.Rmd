...
Estimates a General Linear Model, Mixed Linear Models and Generalized Linear Model with categorial and/or continuous variables, with options to facilitate estimation of interactions, simple slopes, simple effects, post-hoc tests, etc.
