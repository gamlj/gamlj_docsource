...
`r opt("Centered clusterwise")` and `r opt("z-scores clusterwise")` center each score using the mean of the cluster in which the score belongs. For `r opt("z-scores clusterwise")` the score is also divided by the cluster standard deviation. `r opt("Log")` apply a simple natural logarithm transformation to the variable.
