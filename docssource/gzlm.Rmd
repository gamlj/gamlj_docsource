...
Effect size indexes are optionally computed by selecting `Odd rations (expB)`. Odd ratios apply the exponential function to the parameter estimates, thus they make sense for all model where the link function is based on the logarithm.
