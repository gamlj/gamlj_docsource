...
We run the analyses with the GAMLj module in Jamovi. One can follow the example by downloading the [csv file](data/hsbdemo.csv) and open it in [jamovi](https://www.jamovi.org/download.html). Be sure to install GAMLj module from within jamovi library. 
...
<img src="examples/gzlm1/result1_1.png" class="img-responsive" alt="">

Here we can outline the R-squared, that gives information about the goodness of fit of the model (see [technical details](gxlm_specs.html) for more info). Our error of approximation of the data decreases of 4% thanks to the `ses` variable. Put it in another way, our ability to predict `prog` increases of %4 thanks to `ses` over using only the observed probabilities.
...
<img src="examples/gzlm1/results1_3.png" class="img-responsive" alt="">
...
<img src="examples/gzlm1/results2_2.png" class="img-responsive" alt="">

The better one writes, the higher the probability of choosing the academic program (prog=1), and the lower is the probability of choosing the vocational program (prog=3). Choosing the general program does not depends on the writing skills. 
...
<img src="examples/gzlm1/results2_3.png" class="img-responsive" alt="">
...
<img src="examples/gzlm1/results2_5.png" class="img-responsive" alt="">
