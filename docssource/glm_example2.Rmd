...
However, we want to see if the effects of `hours` depend on `type` so we need to include the interactions. We need two interactions: the interaction _linear hours_ by _type_, and _quadratic hours_ by _type_ (I removed _cubic hours_ based on the previous analysis).
