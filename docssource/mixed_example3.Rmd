...
The design and the analyses are inspired by the discussion of the subjects by stimuli analysis reported in [Judd, Westfall, & Kenny, 2012](http://jakewestfall.org/publications/JWK.pdf?fbclid=IwAR2PT2AzWhJhWKIeuzJDD77OKsEi4UHuXfGy8-JppSA_U9wsdlQl7W3OdqY)
...
An example of stimuli crossed with conditions can be: A researcher investigates the effect of colors on reading words. Thirty words are randomly chosen from the dictionary and are used as stimuli in the experiment. The experimental factor is color of the word presented to the participant, repeated within participants: each word is presented to the participant once in blu and once in red on the computer screen. Thus, each participant reads the 30 words twice, once in the blue condition and once in the red condition. This kind of design is often implemented with different orders of presentation of the conditions to counterbalance order effects, making them a split-plot design. We consider this latter variant at the end of this page.

Another example can be an experiment in which the dependent variable is the response times in a task composed by several trials. The task is proposed to the participants in two different conditions. Thus, each participants responds to the same trials twice, once in each condition.

### stimuli nested within conditions

Consider the previos example regarding words and colors. In this new variant two list of words are employed: list A is presented in blue and list B is presented in red. The experimental factor is still color of the word presented to the participant, repeated within participants: each word is presented to the participant either in blu or in red on the computer screen. Thus, each participant reads the 30 words in total, 15 in the blue condition and 15 in the red condition. Also this kind of design can feature counterbalancing. We consider this conterbalanced variant at the end of this page.

Another example of this type of desing can be a research in which participants are asked to make judgments about African American and White males, with each stimulus person described with a name and photo. In this design, the experimental conditions vary the race of the stimulus person, with the individual stimulus persons nested under condition [Judd, Westfall, & Kenny, 2012](http://jakewestfall.org/publications/JWK.pdf?fbclid=IwAR2PT2AzWhJhWKIeuzJDD77OKsEi4UHuXfGy8-JppSA_U9wsdlQl7W3OdqY). If we have, for instance, 20 photos, 10 with White stimulus persons and 10 with African American stimulus persons, the participant responds to each photo producing 20 measures of the dependent variable.
