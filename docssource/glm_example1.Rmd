...
One can change the conditining levels of the moderators by going back to `Covariates scaling` panel. If we want to use the percentiles (25%,50%,75%), for instance, we can flag the option in `Covariates scaling` accordingly.
...
Finaly, in order to give a more honest account of the model fit, we can visualize the simple slopes over the the actual data. 
