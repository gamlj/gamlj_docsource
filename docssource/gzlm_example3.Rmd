...
We first note that the $R^2$ rised up to .50, showing a strong effect of `brand`. We can also appreciate that the `Value/DF` index is now 0.987, practically 1: the model in now well in line with the assumption of the  Poisson model, and no overdispersion is present.
