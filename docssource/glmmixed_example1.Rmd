...
Each school has a different number of students, ranging from `r min(table(data$school))` to `r max(table(data$school))`. Each student presents three variable values: the score in the `math` test, the number of `activity` undertaken and whether the exam was passed `pass=1` or not, `pass=0`.
