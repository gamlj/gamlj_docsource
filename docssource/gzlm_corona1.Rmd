...
Here are the data downloaed from the [CSSEGISandData](https://github.com/CSSEGISandData/COVID-19) divided by contries. You can import them in  'r jamovi()` and exercise with them.
