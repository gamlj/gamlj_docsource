...
However, from within the `Generalized mixed models` module one cannot specify whether a variable is a continuous or categorical one, so we have to define variables types in the `Variable view` tab of the SPSS spreadsheet window. 
